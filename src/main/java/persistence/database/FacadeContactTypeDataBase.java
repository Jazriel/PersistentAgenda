...
public class FacadeContactTypeDataBase implements IFacadeContactTypePersistence {
	/**
	 * getContactTypeById(int id). Metodo que devuelve un tipo decontacto por un
	 * id
	 * 
	 * @param id,
	...
	/**
	 * updateContactType(ContactType contactType). Metodo que actualiza un tipo
	 * de contacto con nuevos datos.
	 * 
	 * @param contactType,
	 *            un tipo de contacto.
	 */
	...
	/**
	 * saveContactType(ContactType contactType). Metodo que guarda un tipo de
	 * contacto.
	 * 
	 * @param contactType,
	 *            el tipo de contacto que guardaremos.
	 */
	@Override
