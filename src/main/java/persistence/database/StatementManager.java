...
public class StatementManager {
	...
	/**
	 * Método StatementManager. Método que llama a la conexión a la base de
	 * datos.
	 * 
	 * @throws SQLException
	 *             Excepción de sql
	...
	public void getFilledSaveCallStatement(Call call) throws SQLException {
		...
		PreparedStatement preparedStatement = conn.prepareStatement(textStatement);
		// Prepare statement
		preparedStatement.setInt(1, call.getContact().getId());
		...
		preparedStatement.setString(3, call.getSubject());
		preparedStatement.setString(4, call.getNotes());
		this.preparedStatement = preparedStatement;
	...
	/**
	 * Método getOrderContactsStatement. Método que se encarga de generar la
	 * preparedStatement para la ordenacion de los contactos.
	 * 
	 * @param field
	 *            Campo por el que ordenar.
	 * @throws SQLException
	...
	/**
	 * Método getFilterContactsStatement. Método que se encarga de filtrar los
	 * contactos por campo.
	 * 
	 * @param field
	 *            Campo por el que filtrar.
